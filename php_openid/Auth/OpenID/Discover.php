...
class Auth_OpenID_ServiceEndpoint {
    ...
    {//var_dump("prefer: ");var_dump($this->type_uris);
    ...
    {//var_dump("prefer namespace: ");var_dump($this->preferredNamespace());die;
		if ($this->preferredNamespace() == Auth_OpenID_OPENID2_NS || $this->preferredNamespace() == Auth_OpenID_OPENID1_NS)
			return true;
